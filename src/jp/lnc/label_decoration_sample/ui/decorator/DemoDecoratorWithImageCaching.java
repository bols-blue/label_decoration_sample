 ...
 * @author balajik
 *
 * Use this class instead of DemoDecorator if image caching should be used 
 * Read through Caveat Lector section of the article to know about the problems
 * 
 * Do a Diff with DemoDecorator to see the changes made to use Image Caching 
 */
public class DemoDecoratorWithImageCaching extends LabelProvider implements ILabelDecorator
{
  /**
   * Image Registry 
   */
  private DemoImageRegistry demoImageRegistry_ = new DemoImageRegistry ();
  ...
  public DemoDecoratorWithImageCaching()
  {
    super();
  }
   ...
   * 
   */
  public static DemoDecoratorWithImageCaching getDemoDecorator()
  {
    ...
    {
      return (DemoDecoratorWithImageCaching) decoratorManager.getLabelDecorator(
  ...
  public Image decorateImage(Image baseImage, Object object)
  {
    ...
    try
    {
      ...
      keyOfImage = findAttributesOfResource (decoratorImageKeys,
                                             objectResource);
  ...
  public boolean checkForNewDecoratorChange(IResource resource)
  {
    ...
    /*  else
      {
        if (initialDecoratorList_.contains(resource))
        {
          return false;
        }
  ...
  public void refresh()
  {
    ...
    DemoDecoratorWithImageCaching demoDecorator = getDemoDecorator();
   ...
   */ 
  private String findAttributesOfResource (Vector imageKeys, 
    IResource resource)
  {
    ...
    {
      // The file does not have a extension.. The base icon should be a text icon image
      extension = "txt";
    }
    else
    {
